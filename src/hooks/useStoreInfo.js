  ...
  useEffect(() => {
    ...
    async function load() {
      ...
      setInfo({
        ...
        newsletterEyebrow: data.newsletter_eyebrow || "Junta-te à comunidade",
        newsletterTitle: data.newsletter_title || "Novidades e Promoções",
        newsletterEmailPlaceholder: data.newsletter_email_placeholder || "O teu email",
        newsletterButtonLabel: data.newsletter_button_label || "Subscrever",
